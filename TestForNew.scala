...
object WeblogChangeAnalytical {
  ...
  /*
   * To splite the record to different fields
   * splite the time to segament and generate the sessionid(15m as a session)
   * The algorithm is to group the time to segments
   * */
