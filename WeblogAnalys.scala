...
/**
     ...
     * the session is generate by the algorithm of "CART"(15 Minute was selected ,if we want to get higher accuracy ,we should select
     samll time gap ),if we want to get higer accuracy we can use (1 minute)
